// Type definitions for Electron 11.0.0-nightly.20200812
...
declare namespace Electron {
  ...
  interface App extends NodeJS.EventEmitter {
    ...
    removeListener(event: 'certificate-error', listener: (event: Event,
                                              ...
                                              callback: (isTrusted: boolean) => void) => void): this;
    /**
     * Emitted when the child process unexpectedly dissapears. This is normally because
     ...
     * contains more information about why the child process dissapeared. It isn't
...
**Note:** When unable to detect locale country code, it returns empty string.
     ...
     * approved and therfore shows as `enabled` in Task Manager and Windows settings.
     *
     * @platform darwin,win32
     */
...
See webContents.sendInputEvent for detailed description of `event` object.
  ...
  interface LaunchItems {
    ...
    scope: string;
    /**
     * `true` if the app registry key is startup approved and therfore shows as
