...
async function doStart(): Promise<IDisposable> {
	...
	const webWorkerExtensionHostIframeSrc = `https://extensions-foreign.${info.workspaceClusterHost}/${wsHostPrefix}/static/out/vs/workbench/services/extensions/worker/httpsWebWorkerExtensionHostIframe.html`;
