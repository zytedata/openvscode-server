...
import { ParsedArgs, ErrorReporter, parseArgs, OptionDescriptions, OPTIONS as ALL_OPTIONS, buildHelpMessage, buildVersionMessage } from 'vs/platform/environment/node/argv';
...
const OPTIONS: OptionDescriptions<ParsedArgs> = {
	_: ALL_OPTIONS['_']
};
